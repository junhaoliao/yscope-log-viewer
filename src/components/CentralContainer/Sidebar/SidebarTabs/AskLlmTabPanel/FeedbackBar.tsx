...
const FeedbackBar = ({onSend, scrollToBottom}: FeedbackBarProps) => {
    const [feedbackState, setFeedbackState] = useState<FEEDBACK_STATE>(
        FEEDBACK_STATE.NOT_YET_SELECTED,
    );
    ...
    const showTextarea: boolean =
        feedbackState === FEEDBACK_STATE.HELPFUL || feedbackState === FEEDBACK_STATE.NOT_HELPFUL;
    ...
    return (
        <Card sx={{"--Card-padding": "8px", "border": 0, "maxWidth": "100%"}}>
